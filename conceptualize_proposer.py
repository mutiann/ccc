...
from utils import EntityMention
...
class Proposer:
    ...
    def collect_substitution(self, text: str, concepts: List[EntityMention],
    ...
    def entity_abstract(self, instance, score_method="frequency"):
        pb = self._probase
    ...
    def entity_instantiate(self, concept, score_method='frequency'):
        pb = self._probase
